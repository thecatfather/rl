...
def generate_routefile():
    ...
    pEW = 1. / 11
    pNS = 1. / 30
    with open("my_route.rou.xml", "w") as routes:
        print("""<routes>
...
#These lines establish the feed-forward part of the network used to choose actions
    ...
    W1 = tf.Variable(tf.random_uniform([layer1,num_actions],0,0.01))
    Qout = tf.matmul(l1,W1)
...
#   ======================================================================================================================== 
    ...
    jList = []
    rList = []
    sumoBinary1 = checkBinary('sumo-gui')
    ...
    with tf.Session() as sess:
        ...
        for i in range(num_episodes):
            ...
            while j < 3333:
                ...
                _,W1,los = sess.run([updateModel,W,loss],feed_dict={inputs1:x.reshape((1,state_space_size)),nextQ:targetQ})
                #los = sess.run(loss)
                #print("loss = ",los)
                rAll += r
                s = s1
